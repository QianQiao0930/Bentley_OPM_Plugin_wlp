...
# =============================================================================
# 【公共模块 · 请勿直接运行】
# 本文件仅作为建模库供入口 ``N4-[设备上生根双三角架].py`` 等插件 ``import`` 调用，没有独立入口。
...
支吊架库 ``支吊架公共库``（``SupportType='N4-[设备上生根双三角架]'``）。
"""
...
for _path in (_HERE, _N3_DIR, _PLATE_DIR, _COMMON_DIR):
