...
class BracketByLinePlateTool(DgnElementSetTool):
    ...
    def InstallNewInstance(tool_id=0, tool_settings=None, start_ui_loop=True):
        ...
        if owner:
            active = getattr(BracketByLinePlateTool, '_active_settings', None)
        ...
        if owner:
            BracketByLinePlateTool._active_settings = settings
        ...
        try:
            ...
            if owner:
                BracketByLinePlateTool._active_settings = None
        return tool
