...
已有的 OpenPlant 90° 竖直弯头，再沿竖直方向拉伸确定高度 H，即可生成：
...
H 是所选弯头水平端中心线至构件最低点的竖向距离：有底板取板下表面，
无底板取钢管底端。弯头 DN、外径、
...
DEBUG_LOG = os.path.join(SCRIPT_DIR, '模块', '日志',
                         '竖直弯头的竖直耳轴_debug_log.txt')
SUPPORT_TYPE = 'F2-[竖直弯头的竖直耳轴]'
SUPPORT_CODE = 'F2_VERTICAL_ELBOW_TRUNNION'
